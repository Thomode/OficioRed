...
function HomeAdmin() {
    ...
    const chartData = {
        ...
        series: [dashboardData.cantidadAdmin, dashboardData.cantidadProfesional, dashboardData.cantidadInteresado],
    };
            ...
            <Grid container spacing={3} justifyContent="center">
                <Grid item xs={12} sm={8} md={3}>
                    <Card sx={cardStyle}>
                        <CardContent sx={cardContentStyle}>
                            ...
                            <Typography color="textSecondary" sx={{ ...titleStyle, ...numberStyle }}>
                ...
                <Grid item xs={12} sm={8} md={6} sx={{ display: 'flex', justifyContent: 'center' }}>
                    <Card sx={{ ...cardStyle, width: "100%" }}>
                        <CardContent sx={cardContentStyle}>
                            <Chart options={chartOptions} series={chartData.series} type="donut" height={300} />
                        </CardContent>
                    </Card>
                </Grid>
            </Grid>
