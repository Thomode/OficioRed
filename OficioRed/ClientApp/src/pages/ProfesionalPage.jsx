...
export function ProfesionalPage() {
    ...
    const handleSearch = async () => {
        const data = await profesionalService.getAll(); // Obt�n todos los usuarios
        console.log(data);
        ...
        setProfesionales(filteredProfesionales); // Actualiza la lista de usuarios con el resultado de la b�squeda
    };
